...
public class EmployeeDbAdapter
{
    ...
    private static final String CREATE_TABLE_EMPLOYEEINOES = "CREATE TABLE IF NOT EXISTS " + Tables.EmployeeInfoes + "(" + BaseColumns._ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
	    + EmployeeInfoColumns.EMPLOYEE_ID + " TEXT," + EmployeeInfoColumns.DESCR + " TEXT," + EmployeeInfoColumns.SEX + " TEXT," + EmployeeInfoColumns.DEPART + " TEXT," + EmployeeInfoColumns.JOB
	    + " TEXT," + EmployeeInfoColumns.MOBILE + " TEXT," + EmployeeInfoColumns.TELNBR + " TEXT," + EmployeeInfoColumns.EMIAL + " TEXT" + ");";
