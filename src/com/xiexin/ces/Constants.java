...
public class Constants {
	...
	public static String ROOT = App.getSharedPreference().getString(
			Constants.SERVER_CONFIG_URL, "http://core130.com")
			+ ":"
			+ App.getSharedPreference().getString(Constants.SERVER_CONFIG_PORT,
					"8081");
	...
	public final static String[] RQ001_DATA_DEFAULT = { "RqNbr", "AccType",
			"Duty", "Title", "Depart", "Channel", "CtrlType", "Currency",
			"TotalCost", "BrCost", "AccItem", "Project", "Reason", "IsClosed",
			"Period", "Status", "UpdateUser", "UpdateDT", "CrtDate", "Remark",
			"Version", "EffDate", "Exceed" };

	public final static String[] RQ001_DET_DEFAULT = { "RqNbr", "LineNbr",
			"Summary", "PeopNbr", "BelongKind", "BelongObj", "BelongDep",
			"BelongChannel", "BelongCus", "BelongVendor", "CurrID", "AccItem",
			"Leader", "TotalCost", "VerCost", "UpdateUser", "UpdateDT",
			"CrtDate", "Status", "Remark", "EffDate", "Version", "HappenDate",
			"MSummary" };

	public final static String[] AC001_DATA_DEFAULT = { "VerNbr", "CrtDate",
			"RqNbr", "Duty", "Title", "Depart", "Channel", "TotalCost",
			"VerBrCost", "PayTotal", "Period", "Currency", "PayMethod",
			"AccType", "Bank", "Account", "AccName", "AccItem", "Reason",
			"Project", "BackInvoice", "BusStatus", "Status", "UpdateUser",
			"UpdateDT", "Remark", "Version", "EffDate", "VerBrDate", "PayDate",
			"SuspDate", "IsClosed", "Exceed", "PayMark", "SuspendMark",
			"VerBorrowMark", "PayBank", "BorrowList" };

	public final static String[] AC001_DET_DEFAULT = { "Summary", "VerNbr",
			"LineNbr", "PeopNbr", "BelongKind", "BelongObj", "ObjDescr",
			"CurrID", "ActCost", "AccItem", "UpdateUser", "UpdateDT",
			"CrtDate", "Status", "Remark", "EffDate", "Version", "BelongDep",
			"BelongChannel", "BelongCus", "BelongVendor", "MAccItem",
			"MSummary", "MActCost", "HappenDate" };

	public final static String[] BT001_DATA_DEFAULT = { "BtripNbr", "CrtDate",
			"Period", "Duty", "Area", "Depart", "Title", "Job", "TotalCost",
			"Remark", "PayMethod", "AccType", "Channel", "Currency", "AccName",
			"Account", "Bank", "Reason", "Project", "Status", "BrCost",
			"AccItem", "UpdateUser", "UpdateDT", "Version", "EffDate",
			"IsClosed", "Exceed", "IsMerge" };

	public final static String[] BT001_DET_DEFAULT = { "BtripNbr", "LineNbr",
			"Summary", "DateFm", "DateTo", "Days", "AreaFm", "AreaTo",
			"AreaKind", "Colleague", "Traffic", "Item1", "Item2", "Item3",
			"Item4", "Item5", "Item6", "Item7", "Item8", "Item9", "Item10",
			"Item11", "Item12", "Item13", "Item14", "Item15", "TotalCost",
			"CurrID", "Process", "AccItem", "BelongDep", "BelongChannel",
			"BelongCus", "BelongVendor", "Status", "Descr", "CrtDate",
			"UpdateUser", "UpdateDT", "Remark", "Version", "EffDate",
			"MSummary", "IsValid", "HappenDate" };

	public final static String[] BT003_DATA_DEFAULT = { "BtripNbr", "VerNbr",
			"CrtDate", "Period", "Duty", "Depart", "Title", "Job", "Currency",
			"Area", "TotalCost", "VerBrCost", "PayTotal", "PayMethod",
			"AccName", "Bank", "Account", "Reason", "Remark", "AccType",
			"Channel", "BackInvoice", "BusStatus", "Project", "Status",
			"AccItem", "UpdateUser", "UpdateDT", "Version", "EffDate",
			"SuspDate", "VerBrDate", "PayDate", "IsClosed", "Exceed",
			"PayMark", "SuspendMark", "VerBorrowMark", "IsMerge", "PayBank",
			"BorrowList" };

	public final static String[] BT003_DET_DEFAULT = { "VerNbr", "LineNbr",
			"Summary", "DateFm", "DateTo", "Days", "AreaFm", "AreaTo",
			"AreaKind", "Colleague", "Traffic", "Item1", "Item2", "Item3",
			"Item4", "Item5", "Item6", "Item7", "Item8", "Item9", "Item10",
			"Item11", "Item12", "Item13", "Item14", "Item15", "ActCost",
			"CurrID", "Process", "AccItem", "CrtDate", "UpdateUser",
			"UpdateDT", "Remark", "Version", "EffDate", "BelongDep",
			"BelongChannel", "BelongCus", "BelongVendor", "MAccItem",
			"MSummary", "MActCost", "Status", "Descr", "IsValid", "HappenDate" };

	public final static String[] FA001_DATA_DEFAULT = { "AccItem", "Account",
			"AccType", "BackTime", "Bank", "bDepBorrow", "BorrowType", "BRNbr",
			"Channel", "CrtDate", "Currency", "Depart", "Duty", "EffDate",
			"ID", "PayBank", "PayCost", "PayDate", "PayMethod", "Period",
			"Project", "Reason", "Remark", "RePayCost", "Status", "Title",
			"TotalCost", "UpdateDT", "UpdateUser", "VerBrDate", "VerCost",
			"Version" };

	public final static String[] FA001_DET_DEFAULT = { "BRNbr", "LineNbr",
			"DocType", "DataNbr", "BrCost", "UpdateUser", "UpdateDT",
			"CrtDate", "Status", "Remark", "EffDate", "Version", "MSummary" };

	public final static String[] FA002_DATA_DEFAULT = { "RePayNbr", "CrtDate",
			"Duty", "Title", "Depart", "Channel", "RtnCost", "Currency",
			"PayMethod", "AccType", "AccItem", "Bank", "AccName", "Account",
			"Remark", "UpdateUser", "UpdateDT", "Status", "EffDate", "Version",
			"Period", "bRePayment", "RePayDesc", "VerBrDate", "VerBrCost",
			"RePayType", "Reason" };

	public final static String[] FA002_DET_DEFAULT = { "RePayNbr", "LineNbr",
			"DocType", "DataNbr", "BrCost", "CurRtnCost", "UpdateUser",
			"UpdateDT", "CrtDate", "Status", "Remark", "EffDate", "Version",
			"MSummary" };

	public final static String[] IS001_DATA_DEFAULT = { "LoanNbr", "CrtDate",
			"Duty", "Title", "Depart", "TotalCost", "Currency", "AccType",
			"UpdateUser", "UpdateDT", "Status", "Remark", "EffDate", "Version",
			"LoanType", "Recipient", "Address", "Tel", "ExprCompany" };

	public final static String[] IS001_DET_DEFAULT = { "LoanNbr", "LineNbr",
			"TotalCost", "AccItem", "ExpRtnDate", "InvoiceType", "DocType",
			"DataNbr", "PayNbr", "RtnNbr", "RePayNbr", "ActRtnDate",
			"ActRtnCost", "CrtDate", "UpdateUser", "UpdateDT", "Status",
			"Remark", "EffDate", "Version", "InvNbr", "MSummary" };

	public final static String[] IS002_DATA_DEFAULT = { "RtnNbr", "CrtDate",
			"Duty", "Title", "Depart", "Totalcost", "Currency", "AccType",
			"Returned", "Remark", "UpdateUser", "UpdateDT", "Status",
			"EffDate", "Version" };

	public final static String[] IS002_DET_DEFAULT = { "RtnNbr", "LineNbr",
			"TotalCost", "AccItem", "InvoiceType", "InvNbr", "DocType",
			"DataNbr", "sInvoiceType", "CrtDate", "UpdateUser", "UpdateDT",
			"Status", "Remark", "EffDate", "Version", "MSummary" };
