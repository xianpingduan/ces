...
public class Constants
{
    ...
    public final static String CONN_CHANGED = "conn_changed";
    ...
    public final static String GET_ANNOUNCE_URL = "GetNotice";
    // approval type
    ...
    public final static int CHECK_UPDATE_AUTO=1;
    public final static int CHECK_UPDATE_NOAUTO=2;
