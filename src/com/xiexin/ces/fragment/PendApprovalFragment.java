...
public class PendApprovalFragment extends Fragment implements OnClickListener
{
	...
	public void handleMessage( Message msg )
	{
		...
		case MSG_GET_INVOICE_LIST_SUCCESS :
			...
			{
			    mInvoiceAdapter.addData( invoices , Constants.TYPE_LIST_ADD_APPEND );
			}
	...
	try
	{
		...
		invoice.setAccount( obj.getString( "Account" ).equals( "null" ) ? "" : obj.getString( "Account" ) );
		...
		invoice.setReason( obj.getString( "Reason" ).equals( "null" ) ? "" : obj.getString( "Reason" ) );
