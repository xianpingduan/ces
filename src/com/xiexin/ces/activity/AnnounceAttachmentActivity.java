...
public class AnnounceAttachmentActivity extends Activity implements OnClickListener {

	private static final String TAG = "AnnounceAttachmentActivity";
	...
	public void scrollViewAddData(ArrayList<String> images) {
		...
		if (APNUtil.isWifiDataEnable(mContext)) {
			...
			Toast.makeText(AnnounceAttachmentActivity.this,
						...
						DownloadTask dinfo = (DownloadTask) obj;
							...
							case FAILED_NOFREESPACE:
								if (APNUtil.isWifiDataEnable(mContext)) {
									...
									Toast.makeText(
											AnnounceAttachmentActivity.this,
											getString(R.string.please_download_at_wifi),
											Toast.LENGTH_SHORT).show();
								}
	...
	private void intentToImageGallery(String url) {
		...
		intent.setClass(AnnounceAttachmentActivity.this, ImageGalleryActivity.class);
	...
	private void openFile(String filePath) {
		...
		if (currentPath != null && currentPath.isFile()) {
			...
			//				startActivity(intent);
			//			} else {
			//				Toast.makeText(AnnounceAttachmentActivity.this, "无法打开，请安装相应的软件！",
			//						Toast.LENGTH_SHORT).show();
			//			}
			...
			if(intent!=null){
				...
				Toast.makeText(AnnounceAttachmentActivity.this, "无法打开，请安装相应的软件！",Toast.LENGTH_SHORT).show();
			}
		} else {
			Toast.makeText(AnnounceAttachmentActivity.this, "对不起，这不是文件！",Toast.LENGTH_SHORT).show();
		}
	}
