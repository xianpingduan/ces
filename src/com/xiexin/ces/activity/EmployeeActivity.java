...
public class EmployeeActivity extends Activity implements OnClickListener
{
    ...
    private int mFrom;
    private final HashMap<String, Employee> mSelectMap = new HashMap<String, Employee>();
    ...
    private void initViews()
    {
        ...
        sideBar.setOnTouchingLetterChangedListener(new OnTouchingLetterChangedListener()
        {
            ...
            {
                // 该字母首次出现的位置
                int position = mEmployeeAdapter.getPositionForSection(s.charAt(0));
                if (position != -1)
                {
    ...
    private void doSearch()
    {
        ...
        {
            Toast.makeText(App.getAppContext(), App.getAppContext().getString(R.string.please_enter_employee_name), Toast.LENGTH_SHORT)
                    .show();
            return;
        } else
        {
    ...
    private final Handler mUiHandler = new Handler()
    {
        ...
        public void handleMessage(Message msg)
        {
            ...
            case MSG_GET_EMPLOYEE_LIST_ERROR:
                dismissDialog();
                Toast.makeText(App.getAppContext(), App.getAppContext().getString(R.string.request_appr_road_list_error),
                        Toast.LENGTH_SHORT).show();
                break;
    ...
    private class EmployeeAdapter extends BaseAdapter implements SectionIndexer
    {
        ...
        private final List<Employee> list = new ArrayList<Employee>();

        private final HashMap<String, Boolean> mMap = new HashMap<String, Boolean>();
        ...
        private void bindData(final ViewHolder holder, final Employee employee)
        {
            ...
            holder.employeeFrameRl.setOnClickListener(new View.OnClickListener()
            {
                @Override
                public void onClick(View v)
                {
                    holder.employeeCheckCb.performClick();
                }
            });
        }
