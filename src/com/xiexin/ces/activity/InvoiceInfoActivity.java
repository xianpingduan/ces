...
//		mBtn2.setText(getString(R.string.invoice_attachment));
	...
	private void initData() {
		...
		Logger.d(TAG, "mConnName=" + mConnName + ",mPrgId=" + mPrgid
				+ ",mDatanbr=" + mDatanbr);
	...
	public void onClick(View v) {
		...
		case R.id.plus_sign_rb:
			...
			if (mInvoiceType == Constants.TYPE_APPROVED_TASKS
				...
				Toast.makeText(InvoiceInfoActivity.this, "已审批事项或已发事项不能加签!",
		...
		case R.id.notify_rb:
			...
			if (mInvoiceType == Constants.TYPE_APPROVED_TASKS
					|| mInvoiceType == Constants.TYPE_SEND_ITEM_TASKS) {
				Toast.makeText(InvoiceInfoActivity.this, "已审批事项或已发事项不能知会!",
						Toast.LENGTH_SHORT).show();
			} else {
				notifyRb();
				mCurrentUi = NOTIFY;
	...
	private Handler mUiHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case MSG_GET_INFO_ERROR:
				Toast.makeText(InvoiceInfoActivity.this, (String) msg.obj,
						Toast.LENGTH_SHORT).show();
...
//            }
			...
			msgIv.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					...
					if (obj != null && !((String) obj).isEmpty()) {
						...
						Toast.makeText(InvoiceInfoActivity.this,
								getString(R.string.no_phone_info),
								Toast.LENGTH_SHORT).show();
					}
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (resultCode == RESULT_OK) {
			...
			Logger.d(TAG, "mCurrentUi=" + mCurrentUi + ",mCheckUserId="
