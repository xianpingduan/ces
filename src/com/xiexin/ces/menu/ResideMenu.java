...
public class ResideMenu extends FrameLayout {
    ...
    private final static String TAG= ResideMenu.class.getSimpleName();
    ...
    private float mScaleValue = 0.75f;
    ...
    private void setScaleDirection(int direction) {
        ...
        Logger.d(TAG, "screenWidth="+screenWidth);
...
//        ViewHelper.setScaleY(mContent, rightScale);
    ...
    private AnimatorSet buildTranslateAnimation(View target,float targetX){
        AnimatorSet translate = new AnimatorSet();
        translate.playTogether(
                ObjectAnimator.ofFloat(target,"translationX",targetX),
                ObjectAnimator.ofFloat(target,"translationY",0)
                        );
        translate.setInterpolator(AnimationUtils.loadInterpolator(activity,
